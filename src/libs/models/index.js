...
import FixedSwapContractBsl from "./FixedSwapContract.bsl";
import FixedSwapContractV3 from "./FixedSwapContract.v3";
import FixedSwapContractV4 from "./FixedSwapContract.v4";
import FixedSwapContractV5 from "./FixedSwapContract.v5";

const ETH_URL_MAINNET = 'https://bsc-dataseed.binance.org'
const ETH_URL_TESTNET = 'https://data-seed-prebsc-1-s1.binance.org:8545'
...
class Application {
	...
	getFixedSwapContract =  ({tokenAddress, decimals = 18, contractAddress=null}) => {
		try {
	...
	getFixedSwapContractBsl =  ({tokenAddress, decimals = 18, contractAddress=null}) => {
		try {
			return new FixedSwapContractBsl({
				web3: this.web3,
				tokenAddress: tokenAddress,
				decimals : decimals,
				contractAddress: contractAddress,
	...
	getFixedSwapContractV3 =  ({tokenAddress, decimals = 18, contractAddress=null}) => {
		try {
			return new FixedSwapContractV3({
				web3: this.web3,
				tokenAddress: tokenAddress,
				decimals : decimals,
				contractAddress: contractAddress,
	...
	getFixedSwapContractV5 =  ({tokenAddress, decimals = 18, contractAddress=null}) => {
		try {
			return new FixedSwapContractV5({
				web3: this.web3,
				tokenAddress: tokenAddress,
				decimals : decimals,
				contractAddress: contractAddress,
